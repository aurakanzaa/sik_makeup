              ...
              <div class="col-lg-12">
                  <div class="form-panel">
                      <br>
                       ...
                       echo form_open_multipart('neraca/Update/'.$this->uri->segment(3),$attr);?>
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-sm-5">
                                  <input type="text" name="keterangan" class="form-control" value="<?php echo $neraca[0]->keterangan; ?>">
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-5">
                                  <input type="date" name="tanggal" class="form-control" value="<?php echo $neraca[0]->tgl_neraca; ?>">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Total</label>
                              <div class="col-sm-5">
                                  <input type="number" name="total" class="form-control" value="<?php echo $neraca[0]->total_transaksi; ?>">
                              </div>
                          </div>
